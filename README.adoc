...
NOTE: The whole documentation was put together under `melonport/protocol-documentation` as pdf and adoc. To convert adoc to pdf you just need `asciidoctor-pdf`.
